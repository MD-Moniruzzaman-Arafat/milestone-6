...
const newString = `my name is ${name}. i am ${age} years old. i am from ${country}.`;
console.log(newString); */

/* ৩.১ একটা প্যারামিটার ওয়ালা arrow ফাংশন ডিক্লেয়ার করো। এবং সেই ফাংশনের কাজ হবে তুমি কোন ইনপুট দিলে সেই ইনপুট সংখ্যাকে ৫ দিয়ে ভাগ করে আউটপুট দিবে।  */

/* const division = n => n / 5;
const divisionResult = division(10);
...
const multiplyResult = multiply(3, 3, 3);
...
/* const numbrs = [5, 8, 10, 16, 30];
const mul = numbrs.map(number => number * 5);
console.log(mul); */

/* ৬. [ চ্যালেঞ্জিং। গুগলে সার্চ দিয়ে বের করো ] অনেকগুলা সংখ্যার একটা array থেকে শুধু বিজোড় সংখ্যা বের করে নিয়ে আসার জন্য filter ইউজ করো  */

/* const numbrs = [5, 8, 10, 7, 16, 30, 31];
const odd = numbrs.filter(number => number % 2 == 1);
console.log(odd); */
...
/* const products = [
    ...
    { name: 'smart Tv', price: 10000 },
    { name: 'macbook', price: 5000 },
    { name: 'macbooks', price: 5000 }
];
